...
- **SearXNG primary, DDG fallback**: Search via shared SearXNG service
  (`http://searxng.sam-solace-lab-shared.svc.cluster.local:8080`) with DuckDuckGo HTML
...
|----------|---------|---------|
| `SEARXNG_URL` | `http://searxng.sam-solace-lab-shared.svc.cluster.local:8080` | SearXNG endpoint |
