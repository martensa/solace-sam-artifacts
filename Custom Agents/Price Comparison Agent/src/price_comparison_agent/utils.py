...
COMMON_HEADERS = {
    ...
    # Note: Do NOT set Accept-Encoding manually — httpx handles gzip/deflate/br
    # automatically and will decompress the response. Setting it explicitly
    # bypasses httpx's automatic decompression, causing raw gzip bytes
    # to be returned (which breaks .json() and .text parsing).
